...
const imgBTHOME = require('../imgs/BT_home.png');
const imgBTShare = require('../imgs/BT_SHARE.png');
                ...
                <View>
                  <TouchableHighlight 
                      onPress={() => {Actions.timeline(); }}
                       ...
                       activeOpacity={0.5}
                      >
                      <Image style={{width: 62, height: 40 }} source={imgBTHOME}/>
                    </TouchableHighlight>
                </View>
                <View style={{}}>
                    <BotaoCheckin evID={this.props.evID} evNome={this.props.evNome} modalCheckIn={this.props.modalCheckIn}/>
                </View>
                <View>
                   <TouchableOpacity  onPress={this.onOpen.bind(this)}>
                      <Image source={imgBTShare} style={{width: 62, height: 40, backgroundColor: 'transparent'}}/>
                   </TouchableOpacity>
                </View>
              </View>
              </LinearGradient>                         
